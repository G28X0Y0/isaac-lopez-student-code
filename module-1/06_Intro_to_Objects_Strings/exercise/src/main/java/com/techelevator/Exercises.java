...
public class Exercises {
	...
	public String extraEnd(String str) {
		int returnStrIndex = str.length() - 2;
		return str.substring(returnStrIndex) + str.substring(returnStrIndex) + str.substring(returnStrIndex);
	}
	...
	public String firstHalf(String str) {
		int indexes = str.length() / 2;
		return str.substring(0, indexes);
	}
	...
	public String withoutEnd(String str) {
		...
		return str.substring(1, (lastInd - 1));
	}
	...
	public String left2(String str) {
		String prefix = str.substring(2);
		return prefix + str.substring(0, 2);
	}
	...
	public String right2(String str) {
		int indexes = str.length();
		String prefix = str.substring(indexes - 2);
		if (str.length() <= 2) {
			return str;
		}
		return prefix + str.substring(0, (indexes - 2));
	}
	...
	public String twoChar(String str, int index) {
		if (str.length() == 2 || index + 2 > str.length() || index < 1) {
			return str.substring(0, 2);
		}
	...
	public String altPairs(String str) {
		...
		for (int i = 0; i < str.length(); i++) {
			if (i % 4 == 0 || i % 4 == 1) {
				char current = str.charAt(i);
				String toString = String.valueOf(current);
	...
	public String stringYak(String str) {
		...
		for (int i = 0; i < str.length(); i++) {
			...
			if(current == 'y'){
				if(i + 2 < str.length()) {
					if (str.charAt(i + 1) == 'a' && str.charAt(i + 2) == 'k') {
						i += 2;
						continue;
					}
				}
